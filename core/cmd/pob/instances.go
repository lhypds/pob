...
// a directory under ~/.pob holding its own settings, instruction, macro and
// logs; ~/.pob/INSTANCE names the one in use. These commands are how that
// pointer is moved without editing the file by hand.
package main
