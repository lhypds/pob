...
Install psl in the guest and give it a key — `.pslrc` or `OPENAI_API_KEY` —
...
prints the address to use — `http://192.168.1.42:8033/` — and the instance ID,
`pb-xxxx`, that the operation routes name. From there it is the ordinary
